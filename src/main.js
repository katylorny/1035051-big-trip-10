...
const createCardsTemplate = () => { // <ul class="trip-days">
  return (
...
}; // это вообще то или нет??

const createEditCardTemplate = () => { // Форма создания/редактирования (используется одна форма);
  return (
...
}; // а это? я не понимаю, что в задании называется карточкой
...
render(tripEventsElement, createEditCardTemplate());
